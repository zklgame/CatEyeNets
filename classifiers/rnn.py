...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        word_embed_out, word_embed_cahce = word_embedding_forward(captions_in, W_embed)
        ...
        temporal_affine_out, temporal_affine_cahce = temporal_affine_forward(h, W_vocab, b_vocab)
